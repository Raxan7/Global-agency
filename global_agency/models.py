...
class StudentApplication(models.Model):
    ...
    # Declaration
    declaration_applicant_name = models.CharField(max_length=200, blank=True, null=True)
    declaration_date = models.DateField(null=True, blank=True)
    declaration_signature_name = models.CharField(max_length=200, blank=True, null=True)
    terms_accepted = models.BooleanField(default=False)

    # Office Use
    office_director_name = models.CharField(max_length=200, blank=True, null=True)
    ...
    # Work Experience 1
    work1_company_name = models.CharField(max_length=200, blank=True, null=True)
    work1_position = models.CharField(max_length=200, blank=True, null=True)
    ...
    work1_region = models.CharField(max_length=120, blank=True, null=True)
    work1_region_post_code = models.CharField(max_length=30, blank=True, null=True)
    work1_district = models.CharField(max_length=120, blank=True, null=True)
    work1_district_post_code = models.CharField(max_length=30, blank=True, null=True)
    work1_ward = models.CharField(max_length=120, blank=True, null=True)
    work1_ward_post_code = models.CharField(max_length=30, blank=True, null=True)
    work1_street = models.CharField(max_length=180, blank=True, null=True)
    work1_employment_type = models.CharField(max_length=100, blank=True, null=True)
    work1_duties = models.TextField(blank=True, null=True)
    work1_supervisor = models.CharField(max_length=200, blank=True, null=True)
    work1_remarks = models.TextField(blank=True, null=True)

    # Work Experience 2
    work2_company_name = models.CharField(max_length=200, blank=True, null=True)
    work2_position = models.CharField(max_length=200, blank=True, null=True)
    ...
    work2_region = models.CharField(max_length=120, blank=True, null=True)
    work2_region_post_code = models.CharField(max_length=30, blank=True, null=True)
    work2_district = models.CharField(max_length=120, blank=True, null=True)
    work2_district_post_code = models.CharField(max_length=30, blank=True, null=True)
    work2_ward = models.CharField(max_length=120, blank=True, null=True)
    work2_ward_post_code = models.CharField(max_length=30, blank=True, null=True)
    work2_street = models.CharField(max_length=180, blank=True, null=True)
    work2_employment_type = models.CharField(max_length=100, blank=True, null=True)
    work2_duties = models.TextField(blank=True, null=True)
    work2_supervisor = models.CharField(max_length=200, blank=True, null=True)
    work2_remarks = models.TextField(blank=True, null=True)

    # Professional Qualification 1
    profq1_title = models.CharField(max_length=255, blank=True, null=True)
    profq1_institution = models.CharField(max_length=255, blank=True, null=True)
    ...
    profq1_period = models.CharField(max_length=100, blank=True, null=True)
    ...
    profq2_title = models.CharField(max_length=255, blank=True, null=True)
    profq2_institution = models.CharField(max_length=255, blank=True, null=True)
    ...
    profq2_period = models.CharField(max_length=100, blank=True, null=True)
    ...
    profq3_title = models.CharField(max_length=255, blank=True, null=True)
    profq3_institution = models.CharField(max_length=255, blank=True, null=True)
    ...
    profq3_period = models.CharField(max_length=100, blank=True, null=True)
