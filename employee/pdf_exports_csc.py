...
def application_to_awec_csc_style_data(application: Any, student_profile: Any = None, supplemental_profile: Any = None) -> Dict[str, Any]:
    ...
    data: Dict[str, Any] = {
        ...
        "personal": {
            ...
            "Form Six School Address": _as_text(_safe_get(student_profile, "alevel_school_street")),
        ...
        "emergency": {
            ...
            "Address (Street/Village/House No.)": _as_text(_safe_get(student_profile, "emergency_street")),
        },
