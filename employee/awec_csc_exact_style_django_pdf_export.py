...
def application_to_awec_csc_style_data(application: Any, student_profile: Any = None, supplemental_profile: Any = None) -> Dict[str, Any]:
    ...
    data["personal"] = {
        ...
        "Native Language": val(_first_attr(supplemental_profile, ["native_language"], _safe_get(student_profile, "native_language"))),
        "Marital Status": val(_first_attr(supplemental_profile, ["marital_status"], _safe_get(student_profile, "marital_status"))),
        "City": val(_first_attr(supplemental_profile, ["city", "current_city", "permanent_city"], _safe_get(student_profile, "city"))),
        "Region": val(_first_attr(supplemental_profile, ["region", "current_region", "permanent_region"], _safe_get(student_profile, "region"))),
        "Ward": val(_first_attr(supplemental_profile, ["ward", "current_ward", "permanent_ward"], _safe_get(student_profile, "ward"))),
        "Village": val(_first_attr(supplemental_profile, ["village", "current_village", "permanent_village", "current_place_neighbourhood", "permanent_place_neighbourhood"], _safe_get(student_profile, "village"))),
        "Street": val(_first_attr(supplemental_profile, ["street", "current_street", "permanent_street"], _safe_get(student_profile, "street"))),
        "House Number": val(_first_attr(supplemental_profile, ["house_number", "house_no", "current_house_no", "permanent_house_no"], _first_attr(student_profile, ["house_number", "house_no"]))),
        ...
        "Passport Issued Date": _date_text(_first_attr(supplemental_profile, ["passport_issued_date", "passport_issue_date", "passport_date_of_issue"])),
        "Passport Expired Date": _date_text(_first_attr(supplemental_profile, ["passport_expired_date", "passport_expiry_date", "passport_expiration_date", "passport_date_of_expiry"])),
    ...
    data["parents"] = {
        "Father": {
            ...
            "Country": val(_first_attr(student_profile, ["father_country"], "Tanzania")),
            "Region": val(_safe_get(student_profile, "father_region")),
            "Region Post Code": val(_first_attr(student_profile, ["father_region_post_code", "father_postal_code"])),
            ...
            "Street": val(_first_attr(student_profile, ["father_street", "father_street_village"])),
            "Place / Neighbourhood": val(_first_attr(student_profile, ["father_place_neighbourhood", "father_neighbourhood", "father_address"])),
        ...
        "Mother": {
            ...
            "Country": val(_first_attr(student_profile, ["mother_country"], "Tanzania")),
            "Region": val(_safe_get(student_profile, "mother_region")),
            "Region Post Code": val(_first_attr(student_profile, ["mother_region_post_code", "mother_postal_code"])),
            ...
            "Street": val(_first_attr(student_profile, ["mother_street", "mother_street_village"])),
            "Place / Neighbourhood": val(_first_attr(student_profile, ["mother_place_neighbourhood", "mother_neighbourhood", "mother_address"])),
    ...
    data["emergency"] = {
        ...
        "Country": val(_first_attr(student_profile, ["emergency_country"], "Tanzania")),
        ...
        "Street": val(_first_attr(student_profile, ["emergency_street", "emergency_street_village"])),
        "Place / Neighbourhood": val(_first_attr(student_profile, ["emergency_place_neighbourhood", "emergency_neighbourhood", "emergency_address"])),
    ...
    data["education_background"] = [
        {
            ...
            "Start Year": _year_text(_first_attr(student_profile, ["olevel_start_year", "olevel_started_year"])),
            "Completed Year": _year_text(_first_attr(student_profile, ["olevel_completed_year", "olevel_year"])),
            "Division / GPA": val(_safe_get(student_profile, "olevel_gpa")),
            "Country": val(_first_attr(student_profile, ["olevel_school_country"], "Tanzania")),
            ...
            "Street": val(_first_attr(student_profile, ["olevel_school_street", "olevel_street", "olevel_address"])),
            "Place / Neighbourhood": val(_first_attr(student_profile, ["olevel_school_place_neighbourhood", "olevel_school_neighbourhood"])),
        ...
        },
        {
            ...
            "Start Year": _year_text(_first_attr(student_profile, ["alevel_start_year", "alevel_started_year"])),
            "Completed Year": _year_text(_first_attr(student_profile, ["alevel_completed_year", "alevel_year"])),
            "Division / GPA": val(_safe_get(student_profile, "alevel_gpa")),
            "Country": val(_first_attr(student_profile, ["alevel_school_country"], "Tanzania")),
            ...
            "Street": val(_first_attr(student_profile, ["alevel_school_street", "alevel_street", "alevel_address"])),
            "Place / Neighbourhood": val(_first_attr(student_profile, ["alevel_school_place_neighbourhood", "alevel_school_neighbourhood"])),
    ...
    data["addresses"] = {
        ...
        "Current Postal Code": val(_first_attr(supplemental_profile, ["current_postal_code", "current_post_code"])),
        ...
        "Permanent Postal Code": val(_first_attr(supplemental_profile, ["permanent_postal_code", "permanent_post_code"])),
