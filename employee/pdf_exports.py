...
def build_csc_style_application_pdf(application, student_profile=None, supplemental_profile=None):
    ...
    personal_fields = [
        ...
        ('Form Six School Address', getattr(student_profile, 'alevel_address', None) if student_profile else None),
        ...
        ('Form Four School Address', getattr(student_profile, 'olevel_address', None) if student_profile else None),
        ...
        _boxed_table(
            [
                ...
                [
                    ...
                    Paragraph(_escaped(getattr(student_profile, 'olevel_year', None)), styles['body']),
                ...
                [
                    ...
                    Paragraph(_escaped(getattr(student_profile, 'alevel_year', None)), styles['body']),
